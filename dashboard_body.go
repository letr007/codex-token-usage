...
<main>
  ...
  <section data-page="providers">
    <div class="command-grid">
      <section class="section provider-overview-section"><h2><span>AI 接入点总览</span><span class="mini">不计入 Codex 账号池价格和额度</span></h2><div class="section-body"><div class="provider-overview-primary">
        <div class="metric metric-hero" style="--accent:var(--ov-blue)"><div class="metric-topline"></div><div class="metric-head"><div class="metric-title">请求总量</div><span class="metric-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 16.5h2.4l2.2-4.9 3.1 7.2 2.7-5.3H19" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/><path d="M4 5h16v14H4z" fill="none" stroke="currentColor" stroke-width="1.7" rx="3"/></svg></span></div><div class="value" id="pm-requests">-</div><div class="sub" id="pm-success">成功 - · 失败 - · 成功率 -</div><div class="metric-well"><svg class="metric-spark" id="spark-provider-requests" viewBox="0 0 220 54" preserveAspectRatio="none" aria-hidden="true"></svg></div></div>
        <div class="metric metric-hero" style="--accent:var(--ov-purple)"><div class="metric-topline"></div><div class="metric-head"><div class="metric-title">Token 总量</div><span class="metric-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M6 7.5h12M6 12h12M6 16.5h7.5" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"/><rect x="4" y="4" width="16" height="16" rx="3" fill="none" stroke="currentColor" stroke-width="1.7"/></svg></span></div><div class="value" id="pm-total">-</div><div class="sub" id="pm-token-split">输入 - · 输出 - · 缓存 -</div><div class="metric-well"><svg class="metric-spark" id="spark-provider-total" viewBox="0 0 220 54" preserveAspectRatio="none" aria-hidden="true"></svg></div></div>
      </div><div class="provider-overview-mid">
        <div class="metric metric-mid" style="--accent:var(--ov-amber)"><div class="metric-topline"></div><div class="metric-head"><div class="metric-title">费用估算</div><span class="metric-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M12 5v14M8.5 8.5c0-1.5 1.4-2.5 3.5-2.5s3.5 1 3.5 2.5-1.4 2.3-3.5 2.5-3.5 1-3.5 2.5 1.4 2.5 3.5 2.5 3.5-1 3.5-2.5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div><div class="value" id="pm-cost">-</div><div class="sub" id="pm-cost-sub">基于 - Token 估算</div><div class="metric-well"><svg class="metric-spark" id="spark-provider-cost" viewBox="0 0 180 46" preserveAspectRatio="none" aria-hidden="true"></svg></div></div>
        <div class="metric metric-mid" style="--accent:var(--ov-blue)"><div class="metric-topline"></div><div class="metric-head"><div class="metric-title">输入 Token</div><span class="metric-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h13M14 7l5 5-5 5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div><div class="value" id="pm-input">-</div><div class="sub" id="pm-input-share">占比 -</div><div class="metric-well"><div class="metric-bar"><span id="pm-input-bar"></span></div></div></div>
        <div class="metric metric-mid" style="--accent:var(--ov-purple)"><div class="metric-topline"></div><div class="metric-head"><div class="metric-title">输出 Token</div><span class="metric-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M19 12H6M10 7l-5 5 5 5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div><div class="value" id="pm-output">-</div><div class="sub" id="pm-output-share">占比 -</div><div class="metric-well"><div class="metric-bar"><span id="pm-output-bar"></span></div></div></div>
        <div class="metric metric-mid" style="--accent:var(--ov-cyan)"><div class="metric-topline"></div><div class="metric-head"><div class="metric-title">缓存率</div><span class="metric-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M6 8.5h12v8a3 3 0 0 1-3 3H9a3 3 0 0 1-3-3v-8Z" fill="none" stroke="currentColor" stroke-width="1.8"/><path d="M9 8V6.8A3.8 3.8 0 0 1 12.8 3h1.4" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg></span></div><div class="value" id="pm-cache">-</div><div class="sub" id="pm-cache-share">命中 - / 输入 -</div><div class="metric-well"><div class="metric-bar"><span id="pm-cache-bar"></span></div></div></div>
      </div><div class="provider-overview-compact">
        <div class="metric" style="--accent:var(--ov-red)"><div class="metric-topline"></div><div class="metric-title">限流</div><div class="value bad" id="pm-429">-</div><div class="sub">Provider 限流</div></div>
        <div class="metric" style="--accent:var(--ov-blue)"><div class="metric-topline"></div><div class="metric-title">接入点</div><div class="value" id="pm-providers">-</div><div class="sub">Provider / endpoint</div></div>
        <div class="metric" style="--accent:var(--ov-purple)"><div class="metric-topline"></div><div class="metric-title">模型数</div><div class="value" id="pm-models">-</div><div class="sub">按模型聚合</div></div>
        <div class="metric" style="--accent:var(--ov-cyan)"><div class="metric-topline"></div><div class="metric-title">Top 接入点</div><div class="value" id="pm-topshare">-</div><div class="sub">Token 集中度</div></div>
        <div class="metric" style="--accent:var(--ov-green)"><div class="metric-topline"></div><div class="metric-title">平均耗时</div><div class="value" id="pm-latency">-</div><div class="sub" id="pm-latency-sub">慢请求 -</div></div>
        <div class="metric" style="--accent:var(--ov-orange)"><div class="metric-topline"></div><div class="metric-title">首 Token</div><div class="value" id="pm-ttft">-</div><div class="sub" id="pm-ttft-sub">慢首包 -</div></div>
        <div class="metric" style="--accent:var(--ov-purple)"><div class="metric-topline"></div><div class="metric-title">输出速度</div><div class="value" id="pm-throughput">-</div><div class="sub">输出 Token / 秒</div></div>
      </div></div></section>
...
<div id="invalid-auth-modal" class="modal-backdrop" hidden>
  <div class="modal-panel invalid-auth-panel" role="dialog" aria-modal="true" aria-labelledby="invalid-auth-title">
    <div class="modal-head"><div class="modal-title-actions"><h2 id="invalid-auth-title">管理 401 失效账号</h2><button id="invalid-auth-release-all" class="ghost compact-danger" type="button">解除所有 401</button><button id="invalid-auth-delete-all" class="ghost danger-ghost compact-danger" type="button">删除所有认证文件</button></div><button id="invalid-auth-close" class="icon-button ghost" type="button" aria-label="关闭 401 管理">×</button></div>
    <div class="modal-body">
    ...
    <div class="modal-actions">
      ...
      <button id="invalid-auth-release-selected" class="ghost" type="button">解除选中 401</button>
      <button id="invalid-auth-delete-selected" class="ghost danger-ghost" type="button">删除选中认证文件</button>
